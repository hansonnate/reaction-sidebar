...
function csvToArray(str, delimiter = ",") {
  ...
  const arr = rows.map(function (row) {
    ...
    if (row.includes("\"")) {
      ...
      else { //if some other (lastname or email) string has a comma
        while (row.indexOf('"') > -1) {
...
function capitalize(fullArray) {
  ...
  for (let i = 0; i < fullArray.length; i++) {
    ...
    fullArray[i]["firstname"] = fullArray[i]["firstname"].charAt(0).toUpperCase() + fullArray[i]["firstname"].slice(1);
    fullArray[i]["lastname"] = fullArray[i]["lastname"].toLowerCase();
    fullArray[i]["lastname"] = fullArray[i]["lastname"].charAt(0).toUpperCase() + fullArray[i]["lastname"].slice(1);
...
if (findreplacecheck.checked) {
  ...
  addreplacement.addEventListener('click', function () {
    ...
    modalbody.innerHTML += "<div class=\"modalbox\" id=\"farinputbox" + numFars.toString() + "\"><input style=\"margin-right: 3px;\" class=\"farinput\" id=\"findinput" + numFars.toString() + "\" type=\"text\" placeholder=\"Find\"><input class=\"farinput\" id=\"replaceinput" + numFars.toString() + "\" type=\"text\" placeholder=\"Replace\"></div>";
    numFars++;
  });
  ...
  removereplacement.addEventListener('click', function () {
    if (numFars !== 0) {
      numFars--;
      let replacementLine = document.getElementById("farinputbox" + numFars.toString());
  ...
  addheader.addEventListener('click', function () {
    ...
    modalbody.innerHTML += "<div class=\"modalbox\" id=\"farheader" + numHeaders.toString() + "\"><input class=\"farinput\" id=\"farheaderinput" + numHeaders.toString() + "\" type=\"text\" placeholder=\"Header\" aria-label=\"default input example\"></div>";
    numHeaders++;
  });
  ...
  removeheader.addEventListener('click', function () {
    if (numHeaders !== 0) {
      numHeaders--;
      let headerLine = document.getElementById("farheader" + numHeaders.toString());
...
function hasSuffix(fullArray) {
  ...
  for (let i = 0; i < fullArray.length; i++) {
    ...
    //firstname
    if (!regexAlpha.test(fullArray[i]["firstname"]) && !fullArray[i]["firstname"].includes("-") && !fullArray[i]["firstname"].includes("\'")) {
      //check for suffix
      ...
      if (fullArray[i]["firstname"].includes(", jr") && !fullArray[i]["firstname"].includes(" jr."))
        addWarning("First Name has suffix", fullArray[i]);
        //fullArray[i]["firstname"] = fullArray[i]["firstname"].replace(", jr", "");
      if (fullArray[i]["firstname"].includes(", sr") && !fullArray[i]["firstname"].includes(" sr."))
        addWarning("First Name has suffix", fullArray[i]);
        //fullArray[i]["firstname"] = fullArray[i]["firstname"].replace(", sr", "");
      ...
      if (fullArray[i]["firstname"].includes(", i") && !fullArray[i]["firstname"].includes(", iv"))
        addWarning("First Name has suffix", fullArray[i]);
      ...
      if (!regexAlpha.test(fullArray[i]["firstname"]) && !fullArray[i]["firstname"].includes("-") && !fullArray[i]["lastname"].includes("\'")) {
        //addWarning("First Name has special character", fullArray[i]);
      }
    }
    //lastname
    if (!regexAlpha.test(fullArray[i]["lastname"]) && !fullArray[i]["lastname"].includes("-") && !fullArray[i]["lastname"].includes("\'")) {
      //check for suffix
      ...
      if (fullArray[i]["lastname"].includes(", jr") && !fullArray[i]["lastname"].includes(" jr."))
        addWarning("Last Name has suffix", fullArray[i]);
        // fullArray[i]["lastname"] = fullArray[i]["lastname"].replace(", jr", "");
      if (fullArray[i]["lastname"].includes(", sr") && !fullArray[i]["lastname"].includes(" sr."))
        addWarning("Last Name has suffix", fullArray[i]);
        // fullArray[i]["lastname"] = fullArray[i]["lastname"].replace(", sr", "");
      ...
      if (fullArray[i]["lastname"].includes(", i") && !fullArray[i]["lastname"].includes(", iv"))
        addWarning("Last Name has suffix", fullArray[i]);
        // fullArray[i]["lastname"] = fullArray[i]["lastname"].replace(", vi", "");
...
function hasPrefix(fullArray) {
  for (let i = 0; i < fullArray.length; i++) {
    if (fullArray[i]["firstname"].includes("Dr.") || fullArray[i]["firstname"].includes("dr.") || fullArray[i]["firstname"].includes("Mr.") ||
        fullArray[i]["firstname"].includes("mr.") || fullArray[i]["firstname"].includes("Ms.") || fullArray[i]["firstname"].includes("ms.") ||
        fullArray[i]["firstname"].includes("Pr.") || fullArray[i]["firstname"].includes("pr.") || fullArray[i]["firstname"].includes("Dr ") ||
        fullArray[i]["firstname"].includes("dr ") || fullArray[i]["firstname"].includes("Mr ") || fullArray[i]["firstname"].includes("mr ") ||
        fullArray[i]["firstname"].includes("Ms ") || fullArray[i]["firstname"].includes("ms ") || fullArray[i]["firstname"].includes("Pr ") ||
        fullArray[i]["firstname"].includes("pr ")) {

      addWarning("Prefix found in first name", fullArray[i]);
    }
    else if (fullArray[i]["firstname"].includes("Dr. ") || fullArray[i]["firstname"].includes("dr. ") || fullArray[i]["firstname"].includes("Mr. ") ||
        fullArray[i]["firstname"].includes("mr. ") || fullArray[i]["firstname"].includes("Ms. ") || fullArray[i]["firstname"].includes("ms. ") ||
        fullArray[i]["firstname"].includes("Pr. ") || fullArray[i]["firstname"].includes("pr. ") || fullArray[i]["firstname"].includes("mrs.") ||
        fullArray[i]["firstname"].includes("Mrs.") || fullArray[i]["firstname"].includes("Mrs ") || fullArray[i]["firstname"].includes("mrs ")) {

      addWarning("Prefix found in first name", fullArray[i]);
    }
    else if (fullArray[i]["firstname"].includes("Mrs. ") || fullArray[i]["firstname"].includes("mrs. ")) {
      addWarning("Prefix found in first name", fullArray[i]);
    }
    if (fullArray[i]["lastname"].includes("Dr.") || fullArray[i]["lastname"].includes("dr.") || fullArray[i]["lastname"].includes("Mr.") ||
        fullArray[i]["lastname"].includes("mr.") || fullArray[i]["lastname"].includes("Ms.") || fullArray[i]["lastname"].includes("ms.") ||
        fullArray[i]["lastname"].includes("Pr.") || fullArray[i]["lastname"].includes("pr.") || fullArray[i]["lastname"].includes("Dr ") ||
        fullArray[i]["lastname"].includes("dr ") || fullArray[i]["lastname"].includes("Mr ") || fullArray[i]["lastname"].includes("mr ") ||
        fullArray[i]["lastname"].includes("Ms ") || fullArray[i]["lastname"].includes("ms ") || fullArray[i]["lastname"].includes("Pr ") ||
        fullArray[i]["lastname"].includes("pr ")) {

      addWarning("Prefix found in last name", fullArray[i]);
    }
    else if (fullArray[i]["lastname"].includes("Dr. ") || fullArray[i]["lastname"].includes("dr. ") || fullArray[i]["lastname"].includes("Mr. ") ||
        fullArray[i]["lastname"].includes("mr. ") || fullArray[i]["lastname"].includes("Ms. ") || fullArray[i]["lastname"].includes("ms. ") ||
        fullArray[i]["lastname"].includes("Pr. ") || fullArray[i]["lastname"].includes("pr. ") || fullArray[i]["lastname"].includes("mrs.") ||
        fullArray[i]["lastname"].includes("Mrs.") || fullArray[i]["lastname"].includes("Mrs ") || fullArray[i]["lastname"].includes("mrs ")) {

      addWarning("Prefix found in last name", fullArray[i]);
    }
    else if (fullArray[i]["lastname"].includes("Mrs. ") || fullArray[i]["lastname"].includes("mrs. ")) {
      addWarning("Prefix found in first name", fullArray[i]);
    }
  }
}
...
function charCount(fullArray) {
  for (let i = 0; i < fullArray.length; i++) {
    ...
    if (fullArray[i]["firstname"].length > charLengthNum.value && fullArray[i]["lastname"].length > charLengthNum.value) {
      //First Name
      addWarning("First name over " +  charLengthNum.value + " characters", fullArray[i]);
      //Last Name
      addWarning("Last name over " +  charLengthNum.value + " characters", fullArray[i]);
    }
...
function singleCharCount(fullArray) {
  for (let i = 0; i < fullArray.length; i++) {
    if (fullArray[i]["firstname"].length === 1 && fullArray[i]["lastname"].length === 1 && fullArray[i]["firstname"] !== "�" && fullArray[i]["lastname"] !== "�") {
      //First Name
      addWarning("First Name is a single character", fullArray[i]);
      //Last Name
      addWarning("Last Name is a single character", fullArray[i]);
    }
    else if (fullArray[i]["firstname"].length === 1 && fullArray[i]["firstname"] !== "�") {
      addWarning("First Name is a single character", fullArray[i]);
    }
    else if (fullArray[i]["lastname"].length === 1 && fullArray[i]["lastname"] !== "�") {
      addWarning("Last Name is a single character", fullArray[i]);
    } //last else ifs are for letters with a period after. Example: A.
    else if (fullArray[i]["firstname"].length === 2 && fullArray[i]["firstname"].match(/[a-z A-Z]/) && fullArray[i]["firstname"].indexOf(".") === 1 &&
              fullArray[i]["lastname"].length === 2 && fullArray[i]["lastname"].match(/[a-z A-Z]/) && fullArray[i]["lastname"].indexOf(".") === 1) {
    ...
    else if (fullArray[i]["lastname"].length === 2 && fullArray[i]["lastname"].match(/[a-z A-Z]/) && fullArray[i]["lastname"].indexOf(".") === 1) {
      addWarning("Last Name is a single character", fullArray[i]);
    }
  }
}
...
function emailDomain(fullArray) {
  for (let i = 0; i < fullArray.length; i++) {
    ...
    if (text.substr(text.length - 5).includes(".com") ||
...
function addWarning(warningText, badContact) {
  ...
  let b = new Object;
  Object.assign(b,a);
  let warning = { "warning": warningText, "record": b.record, "warnNumber": warnCount, "contact": b};
...
function spaceRemoval(fullArray) { //this needs to be edited
...
function dedupe(a) {
    ...
    if (isDeduped === true) {
      ...
      let textToAdd = document.createTextNode(numDupes.toString() + " Duplicate Emails Removed");
...
function toCSV(fullArray, fileName, columnDelimiter = ",", lineDelimiter = "\n") {
  let result, ctr, keys
...
function downloadCSVFile(array,fileName) {
    ...
    CSVFile = new Blob([csvText], { type: "text/csv" });
...
myForm.addEventListener("submit", function (e) {
  ...
  reader.onload = function (e) {
    ...
    let textToAdd = document.createTextNode("Automated cleaning succefully made the following changes:");
    document.getElementById("changes").appendChild(textToAdd);
    document.getElementById("changes").appendChild(document.createElement('br'));
    //clean up array
    ...
    let warnExplain = document.createTextNode("(Contacts with errors are removed from clean list until error is manually ignored or fixed)");
    ...
    if (warningsMap.size === 0) {
      ...
      warningsMap.forEach(function(value, key) {
        ...
        if (value.length > 1) { //there are multiple warnings
          ...
          for (let i = 0; i < value.length; i++) {
            if (!value[i].warning.includes("email") && !value[i].warning.includes("Email")) {
          ...
          if (onlyEmailWarnings) {
            ...
            row_2_data_3.innerHTML = "<strong>Email: </strong><span class=\"errortext\"><u>" + value[0].contact.email + "</u></span> <button type=\"button\" " + "id=\"" + key.toString() + "warning\"" + " class=\"editbutton\" data-bs-toggle=\"modal\" data-bs-target=\"#staticBackdrop\"><i class=\"fa fa-pencil\"></i></button>";
          }
          else {
            row_2_data_2.innerHTML = "Multiple errors detected";
            //print out info depending on error for quick edit
            row_2_data_3.innerHTML = "<button type=\"button\" " + "id=\"" + key.toString() + "warning\"" + " class=\"editbutton\" data-bs-toggle=\"modal\" data-bs-target=\"#staticBackdrop\"><u>Edit<u></button>";
          }
          //ignore action
          ...
          ignoreActionButt.addEventListener('click' , function() {
            ...
            for (let k = 0; k < badContacts.length; k++) {
              if (value[0].contact.email === badContacts[k].email) {
                badContacts[k].changes += "Warnings Ignored : " + value[0].warning;
          ...
          editButt.addEventListener('click' , function() {
            ...
            editInfo.appendChild(document.createTextNode("(Click on value to edit)"));
            ...
            saveButt.addEventListener('click' , function() {
              ...
              for (let i = 0; i < value.length; i++) {
                //first name
                if (editableFName.value !== value[i].contact.firstname && !firstNameEdited) {
                  //add to clean list
                  for (let k = 0; k < badContacts.length; k++) {
                ...
                else if (editableLName.value !== value[i].contact.lastname && !lastNameEdited) {
                  //add to clean list
                  for (let k = 0; k < badContacts.length; k++) {
                    if (value[i].contact.email === badContacts[k].email) {
                ...
                else if (editableEmail.value !== value[i].contact.email && !emailEdited) {
                  //add to clean list
                  for (let k = 0; k < badContacts.length; k++) {
                    if (value[i].contact.email === badContacts[k].email) {
        ...
        else { //if there is only one warning
          //output warning to warningTable
          let row_2 = document.createElement('tr');
          row_2.id = key.toString() + "row";
          let row_2_data_1 = document.createElement('td');
          ...
          else if (value[0].warning.includes("First") || value[0].warning.includes("first")) { //print first name accoording to warning
            row_2_data_3.innerHTML = "<strong>First Name: </strong><span class=\"errortext\"><u>" + value[0].contact.firstname + "</u></span> <button type=\"button\" " + "id=\"" + key.toString() + "warning\"" + " class=\"editbutton\" data-bs-toggle=\"modal\" data-bs-target=\"#staticBackdrop\"><i class=\"fa fa-pencil\"></i></button>";
          }
          else if (value[0].warning.includes("Last") || value[0].warning.includes("last")) { //print last name accoording to warning
            row_2_data_3.innerHTML = "<strong>Last Name: </strong><span class=\"errortext\"><u>" + value[0].contact.lastname + "</u></span> <button type=\"button\" " + "id=\"" + key.toString() + "warning\"" + " class=\"editbutton\" data-bs-toggle=\"modal\" data-bs-target=\"#staticBackdrop\"><i class=\"fa fa-pencil\"></i></button>";
          }
          else {
    ...
    btnRetry.innerHTML = "<a href=\"https://audiencecleaner.theresearchcloud.com/audiencecleaner2.0/clean.html\" target=\"_blank\" id=\"retrybtn\"><u>Submit new list</u>";
